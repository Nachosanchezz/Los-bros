...
cartan1mesa = choice(lista_cartas)                      #Se elige aleatoriamente las dos cartas de la mesa
...
print("Cartas de la mesa: ", cartas_mesa)              #Se muestran las cartas de la mesa
valor_cartas_mesa = cartas[cartan1mesa] + cartas[cartan2mesa]
print("Valor de las cartas de la mesa: ", valor_cartas_mesa)    #Se muestran el valor de las cartas de la mesa

if puntosjugador>valor_cartas_mesa<21:
    print("Has ganado")                                    #Se comparan las cartas del jugador con las de la mesa
